...
public static class HelpCatalog
{
    ...
    [
        ...
        Topic("recording-levels", "RECORDING", "Recording and the Level Assistant",
            ...
            "record vinyl input device mix format check levels true peak projected rms crest clipping gain count-in punch loudness lufs noise floor hum dc clicks history needle stylus automatic start",
